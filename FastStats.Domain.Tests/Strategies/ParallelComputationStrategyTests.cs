...
public sealed class ParallelComputationStrategyTests
{
    private readonly ParallelComputationStrategy _strategy = new();

    [Fact]
    public async Task ComputeMedianAsync_OddNumberOfElements_ReturnsMiddleElement()
    {
        // Arrange
